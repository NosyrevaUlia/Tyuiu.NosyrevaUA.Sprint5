...
namespace Tyuiu.NosyrevaUA.Sprint5.Task6.V20
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Дан файл С:DataSprint5InPutDataFileTask6V20.txt (файл взять из архива   *");
            ...
            Console.WriteLine("Количество шестибуквенных слов = " + res);
            Console.ReadLine();
